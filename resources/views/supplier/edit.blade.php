<form action="/supplier/{{ $supplier->kode_splr }}/update" method="POST" id="frmproduk" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $supplier->kode_splr }}" id="kode_splr" class="form-control" minlength="1" maxlength="4"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $supplier->nama_splr }}" id="nama_splr" class="form-control" autocomplete="off"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $supplier->no_hp }}" id="no_hp" class="form-control" autocomplete="off"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon">
                ...
                <input type="text" value="{{ $supplier->alamat }}" name="alamat" id="alamat" class="form-control" placeholder="Alamat Lengkap"
                    autocomplete="off">
            </div>
        </div>
    </div>
