                                            ...
                                            <div class="col-5">
                                                <div class="input-icon">
                                                    ...
                                                    <input class="form-control" placeholder="Pilih tanggal" readonly
                                                        ...
                                                        value="{{ Request('tanggal') }}" autocomplete="off">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-1">
                                                <div class="form-group">
                                                    <button type="reset" id="reset" name="reset"
                                                        ...
                                                        onclick="window.location.href='/pembelian-detail'">
                                                            ...
                                                            <td>
                                                                <div class="text-center">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        @if ($hariini == $s->tanggal)
                                                                            <form
                                                                                action="/pembelian-detail/{{ $s->kode_transaksi }}/delete"
