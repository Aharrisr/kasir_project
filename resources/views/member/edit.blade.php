<form action="/member/{{ $member->id_member }}/update" method="POST" id="frmproduk" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="" id="nama" class="form-control" autocomplete="off"
                    name="nama" placeholder="Nama Lengkap" oninput="capitalizeFirstLetter(this)">
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="" id="alamat" class="form-control" autocomplete="off"
