                ...
                <div class="col-12">
                    <div class="card shadow-lg p-2 mb-5 rounded">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row"><label for="">Nama Petugas : <?php echo e($user->nama_user); ?></label></div>
                            <form action="/penjualan/<?php echo e($kode_transaksi); ?>/update" method="POST" id="frmpenjualan"
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="table-responsive">
                                                <table class="table table-vcenter card-table table-striped"
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $penjualan_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($s->kode_transaksi == $kode_transaksi): ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        Rp. <?php echo e(number_format($s->harga_jual, 0, ',', '.')); ?>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <span class="subtotal-text">
                                                                            <input type="text" name="subtotal"
                                                                                id="subtotal"
                                                                                value="<?php echo e($s->harga_jual * $s->jumlah); ?>"
                                                                                hidden>
                                                                            <span>Rp.
                                                                                <?php echo e(number_format($s->harga_jual * $s->jumlah, 0, ',', '.')); ?></span>
                                                                        </span>
                                                                    </td>
                                                                    <td hidden><input type="text"
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e($s->id_penjualan_detail); ?>"
                                                                        ...
                                                                        <input type="text" name="petugas"
                                                                            id="petugas"
                                                                            value="<?php echo e($user->nama_user); ?>">
                                                                    </td>
                                                                    <td class="text-center">
                                                                        <button type="button"
                                                                            class="btn btn-danger btn-sm delete-btn"
                                                                            data-id="<?php echo e($s->id_penjualan_detail); ?>">
                                        ...
                                        <?php echo e($penjualan_detail->links('vendor.pagination.bootstrap-5')); ?>
                                            ...
                                            <div class="col-4 d-flex flex-column align-items-end">
                                                <div class="d-flex align-items-center mb-2">
                                                    ...
                                                    <datalist id="datalistOptions">
                                                        <?php $__currentLoopData = $member; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                <?php echo e(Request('kode_member') == $d->kode_member ? 'selected' : ''); ?>

                                                                value="<?php echo e($d->kode_member); ?>"><?php echo e($d->nama); ?>
                            ...
                            <div class="form-group mt-2" style="text-align: right;">
                                <form action="/penjualan/<?php echo e($kode_transaksi); ?>/cancel" method="POST"
                                    ...
                                    <table class="table table-vcenter card-table table-striped">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $produk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <form action="/penjualan/<?php echo e($s->kode_produk); ?>/tambah" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <tr>
                                                        <td class="text-center">
                                                        ...
                                                        <td class="text-center" id="harga"><input type="text"
                                                                hidden name="harga_jual" value="<?php echo e($s->harga_jual); ?>">
                                                            <?php echo e(number_format($s->harga_jual, 0, ',', '.')); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\project kasir\kasir\resources\views/transaksi/index.blade.php ENDPATH**/ ?>