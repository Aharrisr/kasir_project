<?php $__env->startSection('content'); ?>
    <div class="container-xl">
        <div class="col-12 mt-3">
            <form action="/profile/<?php echo e($user->id); ?>/update" method="POST" class="card">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input class="form-control" placeholder="your-email@domain.com" value="<?php echo e($user->email); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\project kasir\kasir\resources\views/profile/index.blade.php ENDPATH**/ ?>