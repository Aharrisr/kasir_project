    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="input-icon mb-2">
                ...
                <input type="text" value="<?php echo e($produk->harga); ?>" id="harga" class="form-control" name="harga"
                    placeholder="Harga">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="input-icon mb-2">
                ...
                <input type="number" minlength="1" maxlength="3" value="<?php echo e($produk->discount); ?>" id="discount"
